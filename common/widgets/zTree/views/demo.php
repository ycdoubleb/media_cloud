<div id="zTree-dropdown-<?= $id ?>" class="zTree-dropdown-container zTree-dropdown-container--krajee">
    <!-- 模拟select点击框 以及option的text值显示-->
    <span class="zTree-dropdown-selection zTree-dropdown-selection--single" >
